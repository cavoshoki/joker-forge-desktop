...
export const generateUnlockJokerFunction = (jokerData: JokerData) => {
  ...
  check_for_unlock = function(self,args)
    if args.type == "${String(unlockTrigger)}" then
      local count = 0`;
...
export const generateUnlockVoucherFunction = (voucherData: VoucherData) => {
